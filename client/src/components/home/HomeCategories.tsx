    ...
    <section className="py-16">
        <div className="max-w-7xl mx-auto">
            <div>
                ...
                <p className="text-sm text-app-text-light mt-1">Explore our wide range of fresh and organic products</p>
            </div>
            <div className="flex items-center mt-8 overflow-x-scroll no-scrollbar">
                {categoriesData.map((category, i) => (
                    <Link key={category.slug} to={`/products?category=${category.slug}`} className="grop flex flex-col items-center gap-3 p-4">
